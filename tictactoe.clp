 	...
 	(if (and 	(equals ?slot1.row ?slot2.row ?slot3.row) 
	 	...
	 	then (return TRUE)
				...
				then(return TRUE) 
						...
						(and 
						 	(or 
							 	(and (eq ?slot1.diag ?slot2.diag) (eq ?slot3.diag "Both") (not (eq ?slot1.diag "None")))
								(and (eq ?slot2.diag ?slot3.diag) (eq ?slot1.diag "Both") (not (eq ?slot2.diag "None")))
